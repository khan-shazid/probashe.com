...
<li><a href="{{ url('/contact') }}"><i class="fa fa-fw fa-envelope"></i><span>Contact</span></a></li>
</ul>
</div>
...
<ul>
<li><a href="{{ url('https://www.facebook.com/groups/231973403824695/')}}"><i class="ion-social-facebook"></i></a></li>
