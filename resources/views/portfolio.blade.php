...
<div class="menu__inner">
	<ul>
	<li><a href="{{ url('/index') }}"><i class="fa fa-fw fa-home"></i><span>Home</span></a></li>
	<li><a href="{{ url('/about') }}"><i class="fa fa-fw fa-info"></i><span>About</span></a></li>
	<li><a href="{{ url('/index') }}"><i class="fa fa-fw fa-users"></i><span>Team</span></a></li>
	<li><a href="{{ url('/index') }}"><i class="fa fa-fw fa-gear"></i><span>Services</span></a></li>
	<li><a href="{{ url('/index') }}"><i class="fa fa-fw fa-camera"></i><span>Portfolio</span></a></li>
	<li><a href="{{ url('/index') }}"><i class="fa fa-fw fa-envelope"></i><span>Contact</span></a></li>
	</ul>
</div>
